...
release: release_server release_uplay release_launcher_embed
    cargo build --release -p umd_browser
    7z a -tzip 5th-echelon.zip data\ .\target\release\dedicated_server.exe .\target\release\launcher.exe .\target_i686\i686-pc-windows-msvc\release\hooks.dll .\target\release\umd_browser.exe
